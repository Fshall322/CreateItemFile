...
public class CreatItemFile
{
    public static void main(String[] args)
    {
        Scanner input = new Scanner(System.in);
        Path file = Paths.get("J:Customers.txt");
        ...
        try
        {
            ...
            System.out.print("Enter a three digit item number or " + QUIT + " to quit >> ");
            ...
            while(!(itemString.equals(QUIT)))
            {
                ...
                if(!(fileNum.equals("000")))
                    System.out.println("Sorry - iten number " + itemString + " already exists");
                else
                {
                    ...
                    s = itemString + delimiter + description + delimiter + System.getProperty("line.separator");
                    data = s.getBytes();
                    buffer = ByteBuffer.wrap(data);
                    fc.position(itemNum * RECSIZE);
                    fc.write(buffer);
